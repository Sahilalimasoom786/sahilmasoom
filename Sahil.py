#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To sahilmasoom
...
\033[1:96m┃┃╱┃┃╭━╮┃╰━╯┃┃┃╰┫╰━━┫┃┃╰╮
\033[1;96m╰╯╱╰┻╯╱╰┻━━━┻╯╰━┻━━━┻╯╰━╯
\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mSahilmasoom\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"""
jalan("\033[1;96m----------------------//\\")
jalan("\033[1;96m---------------------// ¤ \\")
jalan("\033[1;96m---------------------\\ ¤ //")
jalan("\033[1;96m---------------------- \\//")
...
CorrectUsername = "sahilalimasoom"
CorrectPassword = "sahilmasoom"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:sahil_masoom
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:sahil_masoom
	print logo
	...
	print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;93mSahilmasoom\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"
...
def pilih_super():
	...
	p = ThreadPool(50)
	p.map(main, id)
	print "\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mSahilmasoom\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;93m«---•◈•---Developed By baloch-Hacker--•◈•---»" #Dev:sahil_masoom
                    ...
                    ',   (',                     ' -,    '-, 
                     ',)  (',                        `-,)  ' -, 
                      ',    ',                           `-,  ,',-----, 
                       ',)   ;                              `\,- ---'  
                   ¸,,,,'‡  (;                                   
                  (¸,,,,,';_'\ SAHIL ALI MASOOM HACKER
                    
                        my facebook id Link👇👇
                        https://www.facebook.com/SahilAliMasoom
   
      
                       Checkpoint ID Open After 7 Days

•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;96m ....sahilhacker  Sahilmasoom....... \033[1;93m :
•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                WhatsApp Num
              \033[1;96m 7307325066"""
